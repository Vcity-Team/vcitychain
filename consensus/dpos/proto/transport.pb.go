...
const file_transport_proto_rawDesc = "" +
	"\n" +
	"\x0ftransport.proto\x12\x04dpos\"&\n" +
	"\x10TransportMessage\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04dataB7Z5github.com/Vcity-Team/vcitychain/consensus/dpos/protob\x06proto3"
...
var file_transport_proto_goTypes = []any{
	(*TransportMessage)(nil), // 0: dpos.TransportMessage
}
