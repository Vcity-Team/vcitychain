...
const (
	...
	SyncPeer_GetBlockByHash_FullMethodName = "/v1.SyncPeer/GetBlockByHash"
)
...
type SyncPeerClient interface {
	...
	// Returns a single block by hash
...
func (c *syncPeerClient) GetBlockByHash(ctx context.Context, in *GetBlockByHashRequest, opts ...grpc.CallOption) (*Block, error) {
	out := new(Block)
	err := c.cc.Invoke(ctx, SyncPeer_GetBlockByHash_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSyncPeerServer) GetBlockByHash(context.Context, *GetBlockByHashRequest) (*Block, error) {
...
func RegisterSyncPeerServer(s grpc.ServiceRegistrar, srv SyncPeerServer) {
	// If the following call panics, it indicates UnimplementedSyncPeerServer was
...
func _SyncPeer_GetBlockByHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlockByHashRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncPeerServer).GetBlockByHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SyncPeer_GetBlockByHash_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncPeerServer).GetBlockByHash(ctx, req.(*GetBlockByHashRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SyncPeer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SyncPeer_GetBlockByHash_Handler,
		},
	},
