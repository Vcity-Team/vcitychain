...
## Your environment
- OS and version.
- The version of the Vcity Chain.    
  (*Confirm the version of your Vcity Chain client by running the following command: `vcity version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `vcity peers list --grpc-address GRPC_ADDRESS`.
