@echo off
echo Testing DPoS Vote Fix v5 - dposStoreAdapter AddTx Method Fix...
echo.
...
echo.
echo Testing DPoS vote command with dposStoreAdapter AddTx method...
...
echo 3. Store type information (should show dposStoreAdapter)
echo 4. Transaction pool interface availability
echo 5. Transaction pool integration status
echo 6. DPoS state update status
echo.
...
echo - No more "simulating pool addition" warnings
echo.
echo Stopping node...
