...
// CurrentParamsResult represents the result of the current-params command
...
func (r *CurrentParamsResult) GetOutput() string {
	output, _ := json.MarshalIndent(r.Data, "", "  ")
	return string(output)
}

// GetCurrentParamsCommand returns the current-params command
...
func runCurrentParams(cmd *cobra.Command, args []string) {
