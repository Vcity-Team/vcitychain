module github.com/Vcity-Team/vcitychain
...
// Fixed kryptology to work with gnark-crypto v0.12.1+
replace github.com/coinbase/kryptology => ./tmp_kryptology_fix/kryptology
