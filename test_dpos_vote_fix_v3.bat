@echo off
echo Testing DPoS Vote Fix v3 - Transaction Pool Integration Fix...
echo.
...
echo.
echo Testing DPoS vote command with REAL transaction pool integration...
...
echo 3. Transaction pool integration (should see "Transaction added to pool successfully")
