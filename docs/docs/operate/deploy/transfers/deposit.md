...
For a detailed understanding of how bridging works, please refer to the sequence diagrams available [<ins>here</ins>](https://github.com/Vcity-Team/vcitychain/blob/develop/docs/bridge/sequences.md).
