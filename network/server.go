...
import (
	...
	"github.com/Vcity-Team/vcitychain/network/dial"
	"github.com/Vcity-Team/vcitychain/network/discovery"
...
func (s *Server) removePeer(peerID peer.ID) {
	s.logger.Debug("Peer disconnected", "id", peerID)
